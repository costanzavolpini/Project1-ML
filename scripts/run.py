...
acc0, m0, w0 = execute_all_methods(y_0, tx_0, ids_0, True, degree_0, lambda_=0.01, initial_w=None, max_iters=500, gamma=1e-3)
print("Selected method ", m0)
print("with accuracy %f" %(acc0))

acc1, m1, w1 = execute_all_methods(y_1, tx_1, ids_1, True, degree_1, lambda_=0.01, initial_w=None, max_iters=500, gamma=1e-3)
print("Selected method ", m1)
print("with accuracy %f" %(acc1))

acc2, m2, w2 = execute_all_methods(y_2, tx_2, ids_2, True, degree_2, lambda_=0.01, initial_w=None, max_iters=500, gamma=1e-4)
...
final_prediction = generate_submission(tx_0, tx_1, tx_2, ids_0, ids_1, ids_2, w0, w1, w2, "submission-29-10", [degree_0, degree_1, degree_2])
