...
def replace_missing_values(tx, new_values):
    ...
    # last column has 0 values consequences of the -999.
...
def new_features(input_data, polynomial):
    """Create new features based on physics properties"""
...
# Create the same features in the dataset that were created in the training set
# Since for test set we have more data we do not know if it would affect the correlation, creating untested features
...
# Remove the outliers concerning top and bottom percentiles
